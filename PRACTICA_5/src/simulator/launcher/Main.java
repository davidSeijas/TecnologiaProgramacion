...
//Arguments: -m gui -i resources/examples/ex4.4body.txt -o resources/output/out1.txt -s 10000
...
public class Main {
	...
	private static Options buildOptions() {
		...
		cmdLineOptions.addOption(Option.builder("s").longOpt("steps").hasArg()
				.desc("An integer representing the number of simulation steps. Default value: " + _dstepsDefaultValue + " .").build());
	...
	private static void startBatchMode() throws Exception {
		...
		PhysicsSimulator simulador = new PhysicsSimulator(_dtime, gravityLaws);
		Controller controller = new Controller (simulador, _bodyFactory, _gravityLawsFactory);
		
		controller.loadBodies(is);
		controller.run(_steps, os);
	}
